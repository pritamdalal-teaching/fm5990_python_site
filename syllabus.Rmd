...
#### Course Overview
The purpose of this course is to introduce the R programming language as a computing tool for data science. As this is a course for the Master of Financial Mathematics program, all in-class examples and homework assignments will involve financial data.
...
1. Machine Learning: chapter 5 of *PDSH* + finance examples/exercises from Pritam.
