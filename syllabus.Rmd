...
If you'd like additional resources for Python, the following two are great.  As their titles suggest, McKinney's book focuses on data analysis while Hilpisch teaches Python in a variety of finance contexts.

[Python for Data Analysis](python_for_data_analysis.pdf.pdf) - Wes McKinney

[Introduction to Statistical Learning](introduction_to_statistical_learning.pdf) - James, Witten, Hastie, Tibshirani
