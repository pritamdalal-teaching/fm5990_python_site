...
**Required Reading:** PDSH 

**Supplemental Reading:** [Official Seaborn Tutorials](https://seaborn.pydata.org/tutorial.html)
...
**Topics:** `DataFrame.query()`, discuss the analysis project, non-Jupyter Python.
